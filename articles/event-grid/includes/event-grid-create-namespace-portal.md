...
7. Once the deployment of the resource is successful, select **Go to resource** on the deployment page. 
    ...
    :::image type="content" source="media/create-view-manage-namespaces/create-namespace-deployment-alert.png" alt-text="Image showing the deployment succeeded page with the Go to resource link.":::
